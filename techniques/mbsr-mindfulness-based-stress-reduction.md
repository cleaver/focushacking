...
slug: "mbsr-mindfulness-based-stress-reduction"
...
focus_facets:
  ...
  - energy_recovery
  - studying_learning
summary: "Jon Kabat-Zinn's structured 8-week program combining formal meditation, body scan, mindful yoga, and group discussion to fundamentally rewire stress response and attentional control. The gold standard evidence-based mindfulness intervention."
what_it_is: |
  Jon Kabat-Zinn's structured 8-week program combining formal meditation,
  body scan, mindful yoga, and group discussion to fundamentally rewire
  stress response and attentional control. The gold standard
  evidence-based mindfulness intervention.
  
how_to_do_it: |
  1. Enroll in an 8-week MBSR course (in-person or certified online program).
  2. Attend weekly 2.5-hour sessions covering seated meditation, body scan, and mindful movement.
  3. Commit to 45 minutes of daily home practice using provided guided recordings.
  4. Attend the day-long mindfulness retreat (typically in week 6).
  5. Keep a practice log noting session duration and observations after each session.
...
Jon Kabat-Zinn's structured 8-week program combining formal meditation, body scan, mindful yoga, and group discussion to fundamentally rewire stress response and attentional control. The gold standard evidence-based mindfulness intervention.
