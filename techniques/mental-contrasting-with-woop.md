...
how_to_do_it: |
  ...
  3. Obstacle: identify the most significant internal obstacle that might prevent it (e.g., 'I get distracted by social media.').
...
Gabriele Oettingen's WOOP framework (Wish, Outcome, Obstacle, Plan) combines mental contrasting — vividly imagining a goal alongside the realistic obstacles blocking it — with implementation intentions. This hybrid technique mobilizes motivation and plans for obstruction simultaneously.
