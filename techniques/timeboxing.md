...
focus_facets:
  ...
  - studying_learning
summary: "Assign a fixed, non-negotiable maximum time limit to a task, then stop when the box expires regardless of completion. This leverages Parkinson's Law to prevent perfectionism and over-expansion, producing 'good enough' output efficiently."
what_it_is: |
  Assign a fixed, non-negotiable maximum time limit to a task, then stop
...
how_to_do_it: |
  ...
  3. Begin working immediately with the constraint in mind.
...
Assign a fixed, non-negotiable maximum time limit to a task, then stop when the box expires regardless of completion. This leverages Parkinson's Law to prevent perfectionism and over-expansion, producing 'good enough' output efficiently.
